package com.beck.common.filter.word;
...
public class FileTools {
	...
	public static boolean string2FileLast(String res, String filePath) {
		...
		try {
			...
			bf = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(f,true),"UTF-8"));
//			fw = new FileWriter(f, true);
	...
	public static void replaceFileContent(String srcStr, String replaceStr,
		...
		try {
			...
			BufferedReader bufIn = new BufferedReader(new InputStreamReader(new FileInputStream(filePath),"UTF-8"));
