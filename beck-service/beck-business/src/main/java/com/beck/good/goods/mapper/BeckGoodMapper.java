package com.beck.good.goods.mapper;
 ...
 * @date 2021-12-31
 */
public interface BeckGoodMapper 
{
    /**
     * 查询商品
     * 
     ...
     * @return 结果
     */
    public int deleteByLogicBeckGoodById(String id);
     ...
     * @return 结果
     */
    public int deleteByLogicBeckGoodByIds(String[] ids);
